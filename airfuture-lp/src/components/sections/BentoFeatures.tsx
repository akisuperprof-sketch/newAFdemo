        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <AnimatedSection className="md:col-span-2">
            <AnimatedItem className="h-full">
              <div className="card-surface p-8 md:p-12 h-full flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 w-full h-48 md:h-64 bg-black/5 rounded-2xl flex items-center justify-center overflow-hidden">
                   {/* Fallback box if image isn't dropped in yet */}
                   <div className="text-black/20 font-bold">Image: core.png</div>
                </div>
              </div>
            </AnimatedItem>
          </AnimatedSection>
          ...
          <AnimatedSection className="md:col-span-2">
            <AnimatedItem className="h-full">
              <div className="card-surface p-8 md:p-12 h-full flex flex-col md:flex-row-reverse items-center gap-8">
                <div className="flex-1">
                ...
                <div className="flex-1 w-full h-48 md:h-64 bg-black/5 rounded-2xl flex items-center justify-center overflow-hidden">
                  {/* Fallback box if image isn't dropped in yet */}
                  <div className="text-black/20 font-bold">Image: device.png</div>
                </div>
              </div>
            </AnimatedItem>
          </AnimatedSection>
